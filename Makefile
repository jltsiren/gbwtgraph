...
# GBWT's headers, which these include, constrain members with C++20
# requires-clauses (see gbwt::StoresCharsInSharedMemory), so anything that
...
MY_CXX_FLAGS:=$(filter-out -std=%,$(MY_CXX_FLAGS)) -std=c++20
